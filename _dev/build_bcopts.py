...
.track6::before{content:'';position:absolute;left:5%;right:5%;top:19px;
  height:3px;background:var(--hair)}
.track6 a{position:relative;padding:0 6px 4px;text-align:center;
  color:var(--ink)}
.track6 .pin{width:19px;height:19px;border-radius:50%;background:var(--card);
  margin:10px auto 14px;position:relative;z-index:1;
  box-shadow:0 0 0 3px var(--paper),0 0 0 6px currentColor}
.track6 .t{display:block;font-family:var(--disp);font-weight:800;font-size:15px;
...
.track6 .c{display:block;font-family:var(--mn);font-size:10px;color:var(--dim);
  margin-top:5px}
.track6 .here{position:absolute;top:-16px;left:50%;transform:translateX(-50%);
