...
<meta name="ts:outcome" content="The search in order: the program's own model, the settings the law forbids, the four shelves of seats, and the questions that protect your hours">
<meta name="ts:number" content="At least six applications, one placement office's own advised floor">
<meta name="ts:weight" content="4">
<!-- /ts:meta -->"""

ARTICLE = """<article class="art"><section class="artband"><div class="in"><div><ol class="bcr" aria-label="Breadcrumb"><li><a href="index.html">Therapist Support</a><span class="sep">&rsaquo;</span></li><li><a href="resources.html">Resources</a><span class="sep">&rsaquo;</span></li><li><span aria-current="page">Licensure</span></li></ol><p class="kick">California &middot; the practicum search</p><h1>Finding a practicum site, when <em>nobody owns the finding</em></h1><p class="dek">At 29 of California&rsquo;s 78 MFT programs, nothing public says whose job the placement search is. At 13 more, it is plainly yours. This page is the search, run in the right order: what your program already owes you by statute, the settings no trainee can lawfully use, the four shelves where the seats actually sit, and the questions that decide &mdash; before you accept &mdash; whether a site&rsquo;s hours will count.</p><div class="artmeta"><span>Licensure</span><span>12 min read</span></div><!-- _dev/pixel_concepts.py --><div class="tsshort"><p class="tsk">In short</p><q>How do I actually find a practicum site?</q><p class="tsa">Start from your program&rsquo;s own placement model, strike the settings the statute forbids, then apply wide &mdash; one program&rsquo;s placement office advises at least six sites</p><span class="tsfig">6 applications &middot; the advised floor</span></div><!-- /pixel_concepts --></div><div class="artfig"><b>29 of 78</b><span>California MFT programs publish nothing about whose job the placement search is &mdash; you find out after you enroll.</span></div></div></section><div class="artwrap"><nav class="artnav"><b>On this page</b><a href="#whose-job-the-search-is"><i class="tsn">1</i>Whose job the search is &mdash; your program answers first</a><a href="#settings-the-law-rules-out"><i class="tsn">2</i>The settings the law rules out</a><a href="#where-the-seats-exist"><i class="tsn">3</i>Where the seats actually exist</a><a href="#running-the-search"><i class="tsn">4</i>Running the search</a><a href="#what-to-ask"><i class="tsn">5</i>What to ask before you accept a seat</a><a href="#the-paper-trail"><i class="tsn">6</i>The paper trail, from the first week</a></nav><div class="artbody">
