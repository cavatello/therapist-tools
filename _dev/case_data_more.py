...
MORE = [
    {
        # source: BBS decision 001.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-billed-for-sessions-that-never-happened",
        "group": "money",
        "t": "Twenty-two sessions billed for a patient seen twice",
        "dek": "One payor&rsquo;s audit found <b>$35,329</b> in overcharges across 559 claims; she repaid it, then shredded the files.",
        "role": "LMFT",
        "eff": "May 18, 2023",
        "case": "2002019002464",
        "hear": "OAH No. 2022080424",
        "facts": [
         "The respondent had held a marriage and family therapist license since 1975. Between 2016 and 2019 she billed insurers and a third-party claims administrator for sessions she had not provided. One patient saw her twice in January 2019; she billed for <b>22 sessions</b> spread over eight weeks. Another patient saw her three times in August 2016; she billed for 31. A third saw her twice; she billed for 21. A fourth was seen once, in February 2017; she billed for 36, and submitted progress notes to the payor for sessions that had not taken place. For a fifth patient the payor found she had billed 33 sessions and overbilled for 32 of them.",
         "A managed-care company audited her billing and determined she had overcharged it <b>$35,329</b> across 559 claims found to be in error. She reimbursed the company in full. In August 2020, when a Department of Insurance investigator subpoenaed her records for four of those patients, she said the records had been shredded after she made the repayment. One patient was shown her own signed client-information sheet and noted that the date had been altered and that the handwriting was not hers; the same patient received a $350 bill from her health plan for sessions she had never attended and had to file an appeal to contest it.",
         "The advertising cause concerned a weekend retreat program the respondent ran. Her advertisement said a participant would be more &ldquo;emotionally healed and cleansed&rdquo; and that &ldquo;past participants and professional therapists have stated this weekend is equivalent to one or more years of individual and/or group therapy.&rdquo; She used one new patient&rsquo;s session to give a lengthy pitch for the program, telling him that any other counseling would be a waste of time, that his insurance was great, and that he had nothing to lose. Another patient attended after being told the <b>$1,500</b> cost would be covered by insurance. The retreat did not help her, and when she contacted her plan to find a different therapist she was told her therapy allowance was gone.",
         "In 2022 a married couple saw the respondent for a joint session. She obtained no information from them before starting, told them to stop talking, and said that their sharing their experiences was making &ldquo;her brain hurt.&rdquo; At an individual session five weeks later she again told the wife to stop talking and advised her to end her marriage. She then charged the couple for four dates on which she did not see them. In aggravation the Board pleaded a 1999 citation and $500 administrative penalty against her, then final, for submitting fraudulent billings to an employee assistance program and for disclosing a spouse&rsquo;s diagnosis and treatment plan without a signed authorization."
        ],
        "charges": [
         [
          "B&amp;P &sect;4982(d)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
          "Gross negligence or incompetence in the performance of marriage and family therapy. Charged twice here on the same billing conduct &mdash; once as gross negligence, once as incompetence."
         ],
         [
          "B&amp;P &sect;4982(i)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
         ...
         [
          ...
          "Requires an MFT to retain a client&rsquo;s health service records for at least seven years from termination of therapy, or seven years past the client&rsquo;s eighteenth birthday if the client is a minor."
         ],
         [
          "B&amp;P &sect;4982(v)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
        ...
        "outcome": "License surrendered by stipulation after she had filed a notice of defense contesting an amended accusation. She may not petition for reinstatement, and may reapply only after three years as a new applicant &mdash; current education, current experience, and every examination required of new applicants &mdash; with all charges deemed admitted against any future application.",
        "cost": "$32,956",
        "rule": "A claim has to describe a service that actually happened, on the date it happened, to the person named on it. The progress note is the proof, which is why writing notes for sessions that did not occur is a separate wrong from billing for them. Records must be kept for at least seven years from the end of therapy &mdash; seven years past the eighteenth birthday for a minor &mdash; and repaying a payor does not shorten that clock or release the file for destruction; if anything, an audit is the moment the file becomes evidence. And anything you publish that is meant to induce someone to buy your services, a retreat brochure included, is a public communication under &sect;651: an outcome claim you cannot substantiate is disciplinable whether or not a client complains about it.",
        "ins": "None of this was insurable. Every professional liability policy excludes intentional acts, criminal acts, and fraud, so the overbilling, the restitution, and the destroyed records all sat outside coverage, and cost recovery under &sect;125.3 is not a defense cost &mdash; no sublimit pays it. What a policy does usually pay for is the defense of the licensing-board action itself: the attorney who answers the accusation, the hours spent responding to a subpoena, the negotiation of a stipulation. That benefit is capped, it is generally the smallest number on the declarations page, and it usually requires that you report the matter as soon as you learn of it &mdash; which in a case like this means the day the payor opens an audit, not the day the accusation arrives.",
        "prevent": [
         ...
         "Never destroy a client record because a payor dispute closed &mdash; the seven-year clock runs from termination of therapy, not from settlement.",
    ...
    },
    {
        ...
        "charges": [
         ...
         [
          "B&amp;P &sect;4982(d)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
          "Gross negligence or incompetence &mdash; pleaded here as the abuse of power itself: dissuading clients from reporting, prioritizing his needs over theirs, and entering a dual relationship."
         ],
         [
          "B&amp;P &sect;4982(i)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
         ...
         [
          "B&amp;P &sect;4982(j)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
          "A dishonest, corrupt, or fraudulent act &mdash; charged for his statements to the Board&rsquo;s investigator, not for the underlying conduct."
         ],
         [
          "B&amp;P &sect;729",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=729&amp;lawCode=BPC",
          "Defines sexual exploitation by a psychotherapist, and defines &ldquo;sexual contact&rdquo; as intercourse or the touching of an intimate part for sexual arousal, gratification, or abuse."
         ]
        ],
        "outcome": "Registration surrendered by stipulation; he represented himself throughout. He may not petition for reinstatement and may reapply only after three years as a new applicant, with every charge deemed admitted against any future application to this Board or to the Board of Psychology.",
        "cost": "$33,704",
        "rule": "Sections 726 and 4982(k) reach a great deal short of intercourse. Soliciting sexual relations, sexual abuse, and sexual misconduct all count, and the conduct that builds toward them is the ordinary subject matter of these cases: hugging, massaging shoulders, locking a door, dimming lights, sexual-history questions with no treatment purpose, personal texts after hours. The second rule here is jurisdictional. An employer&rsquo;s response &mdash; a suspension, a required ethics course, a performance improvement plan, a transfer to another site, even a termination &mdash; resolves an employment problem and nothing more. It does not discharge the Board&rsquo;s interest, it does not restart anyone&rsquo;s clock, and under &sect;4990.33 it does not matter that the registration has since lapsed or been canceled.",
        "ins": "Sexual misconduct is the one allegation every California professional liability program treats differently: it is defense-only, capped, and never indemnified, because intentional and criminal acts are excluded from all of them. So the money question in a case like this is not what a policy would pay a client &mdash; it would pay nothing &mdash; but whether the board-defense benefit is available at all, and how early. The dishonesty count is the practical argument for calling your carrier before you speak to an investigator: statements made in an interview became an independent cause for discipline here, and that is exactly the point at which represented and unrepresented respondents diverge.",
        "prevent": [
         "Treat a client&rsquo;s request to switch to a therapist of a different gender as a clinical event: document it, escalate it, and find out what prompted it.",
         "Write your contact rules into the intake &mdash; who initiates, through what channel, about what &mdash; and put every text into the record.",
    ...
    {
        # source: BBS decision 004.txt, redacted by _dev/../bbs pipeline
        ...
        "dek": "Both relationships began before there was a therapy relationship &mdash; one in a classroom where he was the teaching assistant.",
        "role": "LMFT",
        "eff": "March 9, 2023",
        "case": "2002021002361",
        ...
        "charges": [
         ...
         [
          ...
          "On any finding of fact that a licensee engaged in sexual contact with a patient, the Board shall revoke &mdash; and the revocation may not be stayed by the administrative law judge or by the Board."
         ],
         [
          "B&amp;P &sect;4982(d)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
         ...
         [
          "B&amp;P &sect;729",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=729&amp;lawCode=BPC",
          "Makes sexual contact between a psychotherapist and a patient a public offense, and supplies the definition of &ldquo;sexual contact&rdquo; used by the mandatory-revocation provision."
         ]
        ],
        "outcome": "License surrendered by stipulation after he had filed a notice of defense contesting the accusation. He may not petition for reinstatement and may reapply only after three years as a new applicant, with every charge deemed admitted against any future application.",
        "cost": "$14,486",
        "rule": "Two independent rules run through this case. First, administering a controlled substance to a client is disciplinable on its own under &sect;4982(c), and the subdivision does not stop at discretion: the Board shall revoke the license of anyone who uses or offers to use drugs in the course of performing therapy. The client&rsquo;s consent, her enthusiasm, and the therapist&rsquo;s belief in the benefit are not defenses, and no sexual finding is needed. Second, &sect;4982.26 makes revocation mandatory and unstayable on any finding of sexual contact with a patient &mdash; neither the administrative law judge nor the Board has discretion to soften it. Underneath both sits the ordinary rule this case keeps illustrating: a therapy relationship that grows out of a teaching, training, or supervisory role carries that earlier authority into the room, and the client cannot leave it at the door.",
        "ins": "Nothing in this case is insurable. Administering a Schedule I controlled substance is a criminal act, and criminal and intentional acts are excluded from every professional liability policy sold to California therapists; sexual misconduct is defense-only on all of them, never indemnified. That leaves the licensing-board defense benefit, which would have paid some of the cost of answering the accusation and negotiating a stipulation &mdash; but not the <b>$14,486</b> in cost recovery, because cost recovery is not a defense cost and no sublimit reaches it. A therapist considering any form of psychedelic-assisted work should ask the carrier, in writing and before starting, whether the policy responds at all; the usual answer is that it does not.",
        "prevent": [
         ...
         "Keep sessions to a scheduled length and end them in the office &mdash; all-day sessions, rides home, and shared meals are the observable markers a Board looks for when reconstructing a boundary case.",
    ...
    },
    {
        ...
        "facts": [
         ...
         "The Board filed its accusation in January 2023 and served it the next day by certified and first class mail at his address of record &mdash; the address B&amp;P &sect;136 requires every registrant to report and maintain. He filed no notice of defense within 15 days, which under Government Code &sect;11506(c) waived his right to a hearing. Under Government Code &sect;11520 the Board took the matter by default, decided it on a default decision investigatory evidence packet, and found the charges true by clear and convincing evidence."
        ],
        "charges": [
         [
          "B&amp;P &sect;490",
         ...
         [
          "16 CCR &sect;1812",
          null,
          "Defines &ldquo;substantially related&rdquo; for BBS licensees: a crime qualifies if to a substantial degree it evidences present or potential unfitness to perform the licensed functions consistently with public health, safety, or welfare, weighing the nature and gravity of the offense and the years elapsed."
         ],
         [
          "16 CCR &sect;1814",
          null,
        ...
        "outcome": "Registration revoked by default decision. The Board separately found its actual costs of enforcement to be $4,551.25 as of March 15, 2023; the order itself contains no payment term. He had seven days from service of the decision to move to have it vacated for good cause.",
        "cost": "$4,551.25",
        "rule": "A conviction supports discipline when it is substantially related to the qualifications, functions, or duties of the license &mdash; 16 CCR &sect;1812 defines that as conduct evidencing, to a substantial degree, present or potential unfitness to practice consistently with public health, safety, or welfare &mdash; and the record of conviction is conclusive that it happened. The other half of this case is pure procedure, and it is the half that decides outcomes. Business and Professions Code &sect;136 requires you to report and maintain a current address of record; service there is effective as a matter of law whether or not you still live there. A notice of defense is due within 15 days of service. Missing it waives the hearing and lets the Board decide on affidavits and an investigative packet alone.",
        "ins": "A criminal defense is paid out of pocket &mdash; every professional liability policy excludes criminal and intentional acts, with no exception for a plea to a lesser count. The board-defense benefit is the only part of a policy that could have mattered here, and its reach is worth checking before you need it, because many programs tie it to allegations arising out of professional services and this conduct arose outside practice entirely. Even where the benefit applies, cost recovery under &sect;125.3 is not a defense cost and no sublimit pays it. And a default costs nothing to enter and everything to lose: there is no coverage question at all if no one files an answer.",
        "prevent": [
         "Keep your address of record current with the Board and keep reading that mailbox even after you stop practicing &mdash; service there is legally effective, and the Board&rsquo;s jurisdiction survives an expired registration.",
         ...
         "If you are convicted of anything, gather the court records and produce them &mdash; 16 CCR &sect;1814 makes compliance with the sentence and evidence of rehabilitation the criteria the Board actually applies."
        ],
    },
    {
        # source: BBS decision 008.txt, redacted by _dev/../bbs pipeline
        ...
        "dek": "No new clinical misconduct &mdash; one administrative condition breached turned three years of probation into forty-two months.",
        "role": "AMFT",
        "eff": null,
        "case": "2002023000887",
        "hear": null,
        "facts": [
         "The respondent was registered as an associate marriage and family therapist in August 2017. In a prior disciplinary case, decided effective December 8, 2021, the Board revoked her registration, stayed the revocation, and placed her on three years&rsquo; probation. That earlier case rested on a criminal conviction and on her failure to answer the Board.",
         "The conviction was for forgery. In October 2020, in Merced County Superior Court, she was convicted on her plea of violating Penal Code sections 470(d) and 473(a), forgery relating to an item exceeding $950, a felony; she was sentenced to 180 days in jail, three years of formal probation, and fees, fines, and restitution. Between November 2018 and January 2019 she had deposited five forged checks totaling <b>$19,000</b> into her own bank account. The victim was the father of a man she had previously been in a relationship with. She had come to his home in September 2018 asking for help with her car, and while he was outside she asked to use the bathroom and was alone inside for a few minutes. He noticed months later that his account was low, and his bank traced five checks to her; surveillance video from the ATM confirmed she had deposited them. The Board separately charged her under 16 CCR &sect;1845(h) for failing to give it documentation about her arrest after a February 2020 request. That case carried $1,855 in cost recovery and $1,200 a year in probation monitoring costs.",
         "The violation charged in this case is administrative and singular. Probation Condition 14 required her to maintain a current and active registration with the Board at all times while on probation, including any period during which probation was tolled. Her registration had expired on August 31, 2019 &mdash; more than two years before the probation began &mdash; and was never renewed. She was notified in October 2022 that she was out of compliance and that further disciplinary action would follow, which under Condition 13 automatically extended her probation. The petition to revoke probation was filed in December 2022; she filed a notice of defense contesting it, then admitted every allegation in a stipulated settlement. She represented herself in both proceedings.",
         "The Board did not revoke. It ordered the registration revoked, stayed the revocation again, and placed her on <b>42 months&rsquo;</b> probation on a fresh and longer set of conditions: a psychological or psychiatric evaluation by a Board-appointed evaluator within 90 days, at her expense, with compliance required with whatever the evaluator recommends; ongoing weekly psychotherapy with a Board-approved licensed clinician who files quarterly reports on her fitness to practice; a graduate-level law and ethics course equivalent to two semester units, completed within a year and not usable for continuing education credit; fingerprinting through the Department of Justice and the FBI, and written reporting of any violation of law within 72 hours; quarterly reports under penalty of perjury; in-person interviews on request; notification to every current and future employer and to any client whose therapy or confidentiality is affected; a bar on supervising anyone&rsquo;s hours toward licensure; a bar on teaching continuing education; and reimbursement of the Board&rsquo;s probation monitoring at $1,200 per year. If either the evaluator or the treating therapist concludes she cannot practice safely, she must stop immediately and may not resume until the Board says so."
        ],
        "charges": [
         [
         ...
         [
          ...
          "Expiration, cancellation, forfeiture, or surrender of a registration does not deprive the Board of jurisdiction to investigate, to proceed, or to revoke &mdash; the provision that makes a lapsed registration disciplinable at all."
         ],
         [
          "B&amp;P &sect;4982(a)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
          "Conviction of a crime substantially related to the qualifications, functions, or duties of a licensee or registrant &mdash; the first cause in the underlying case."
         ],
         [
          "B&amp;P &sect;4982(j)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4982&amp;lawCode=BPC",
          "Commission of a dishonest, corrupt, or fraudulent act substantially related to the duties of a registrant &mdash; the second cause in the underlying case."
         ],
         [
          "B&amp;P &sect;490",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=490&amp;lawCode=BPC",
        ...
        "outcome": "Registration revoked, revocation stayed, and probation reimposed for 42 months on expanded terms &mdash; longer than the three years she was already serving. The order contains no separate cost recovery term; probation monitoring is reimbursed at $1,200 a year, and the $1,855 in costs from the underlying case remained payable under that earlier decision.",
        "cost": null,
        "rule": "Every condition of a stayed-revocation probation is an independent, self-executing obligation, and the administrative ones are the easiest to breach precisely because they are not about clinical work. &ldquo;Maintain a current and active registration&rdquo; means renewing it on time, every time, including in periods when you are not practicing at all. The non-practice condition spells out what does not pause: obeying all laws, filing quarterly reports, complying with the probation program, maintaining a valid registration, and paying costs. A lapse does not put you outside the Board&rsquo;s reach &mdash; &sect;4990.33 keeps jurisdiction over an expired registration &mdash; and the filing of a petition to revoke automatically extends probation until the Board acts on it. You cannot wait out a probation by not working.",
        "ins": "Probation is the uninsured part of discipline. No policy pays for a Board-ordered psychological evaluation, for weekly psychotherapy you are required to attend, for a graduate law and ethics course that cannot count toward continuing education, for fingerprinting, or for the $1,200 a year in monitoring costs &mdash; and cost recovery is not a defense cost, so no sublimit reaches it either. The underlying conduct, forgery, is a criminal and intentional act excluded from every policy. What is genuinely worth asking your carrier in writing, before you need the answer, is whether the board-defense benefit extends to a petition to revoke probation at all: it is a second proceeding, arising after discipline is already on your record, and policies differ on whether that is a new covered claim or the continuation of an old one.",
        "prevent": [
         "Calendar every probation deadline &mdash; renewal, quarterly report, evaluation, coursework, payment &mdash; in the week the decision becomes effective, not in the month each falls due.",
    ...
    {
        # source: BBS decision 009.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-a-battery-conviction-and-a-default",
        "group": "conviction",
        "t": "A battery conviction ends an associate&rsquo;s registration",
        "dek": "She never filed a notice of defense, so the Board decided the case without her.",
        "role": "ASW",
        "eff": "May 18, 2023",
        "case": "2002022002071",
        "hear": null,
        "facts": [
         "On February 18, 2022, at 4:34 p.m., police responded to a call about a domestic disturbance. The victim, the respondent&rsquo;s former romantic partner, said she assaulted him during an argument while he was moving out of their apartment. He said she struck him in the face and brandished a box cutter. The respondent admitted to officers only that she hit him. Officers searched the apartment and could not find the box cutters. They determined she was the primary aggressor and arrested her.",
         "On July 25, 2022, in the Superior Court of California, County of San Mateo, the respondent was convicted on her plea of guilty to violating Penal Code section 242, battery. She was sentenced to <b>18 months of formal probation</b> until November 26, 2022, followed by another 18 months of summary probation, and was ordered to complete 104 hours of domestic violence counseling, serve 10 days in jail with 4 days of credit, and pay fines and restitution.",
        ...
        "charges": [
         ...
         [
          "16 CCR &sect;1812",
          null,
          "Defines &ldquo;substantially related&rdquo; for this Board: a crime or act qualifies if to a substantial degree it evidences present or potential unfitness to perform licensed functions consistent with public health, safety, or welfare."
         ]
        ],
        "outcome": "Associate Clinical Social Worker registration revoked by default decision and order. The respondent had seven days after service of the decision to move to vacate it for good cause.",
        "cost": null,
        "rule": "A criminal conviction is a free-standing ground for discipline. The Board does not have to show that anything happened in a session, or that a client was involved at all; it has to show a conviction and that the crime is substantially related to the qualifications, functions, or duties of the profession. The record of conviction is conclusive evidence that the conviction occurred, and a guilty or no contest plea is a conviction for this purpose. What the Board can still weigh is the circumstances of the offense and the licensee&rsquo;s rehabilitation, using set criteria: the nature and severity of the act, how much time has passed, compliance with criminal probation, and any evidence of rehabilitation the licensee puts in front of it. That last part only happens if the licensee shows up.",
        "ins": "A professional liability policy will not defend or pay for a criminal case, and every such policy excludes intentional and criminal acts, so nothing about the battery itself is insurable. Conduct in a personal relationship also falls outside &ldquo;professional services&rdquo; entirely. What most policies do include is a license defense benefit, usually a fixed sublimit, that pays a lawyer to respond to a board accusation, and that is the coverage that matters here. It buys a timely notice of defense and someone to present rehabilitation evidence. It cannot help after a default is entered.",
        "prevent": [
    ...
    {
        # source: BBS decision 018.txt, redacted by _dev/../bbs pipeline
        ...
        "dek": "Most of the violations were curable; typing her own certificates of completion was not.",
        "role": "LMFT",
        "eff": "June 13, 2024",
        "case": "2002023001526",
        ...
        "charges": [
         ...
         [
          "Probation Condition 7 &mdash; Comply with Probation Program",
          null,
         ...
         [
          "Probation Condition 19 &mdash; Reimbursement of Probation Program",
          null,
    ...
    {
        # source: BBS decision 034.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-psychology-probation-reaches-a-second-license",
        "group": "another",
        "t": "Psychology board probation reaches a second license",
        "dek": "The 30-day duty to report the first board&rsquo;s discipline became its own cause for discipline.",
        "role": "LEP",
        "eff": "July 24, 2025",
        "case": "2002024002213",
        ...
        "charges": [
         ...
         [
          ...
          null,
          "Requires a licensee to report to the Board within 30 days any disciplinary action taken by another licensing entity or authority of this state, another state, a federal agency, or the United States military. Charged in conjunction with B&amp;P &sect;4989.54 as unprofessional conduct."
         ]
        ],
        "outcome": "Licensed Educational Psychologist license revoked, the revocation stayed, and three years of probation imposed. The supervised practice condition is deemed satisfied by the supervised practice she is already doing under the Board of Psychology probation.",
        "cost": "$2,000.00",
        "rule": "If you hold more than one license or registration in the healing arts, discipline on one is, by statute, unprofessional conduct on the others. The second board does not relitigate the underlying facts: a certified copy of the first decision is conclusive evidence of the discipline. Separately, and independently, you have an affirmative duty to report that discipline to every board that licenses you, within 30 days. The clock starts with the other agency&rsquo;s action, not with the date the second board finds out, and the failure to report is charged as its own cause for discipline, carrying its own consequences even if the derivative discipline would have arrived anyway.",
        "ins": "Professional liability coverage does not respond to a derivative disciplinary action of this kind; the loss is the license, not a claim by a client, and the misconduct alleged in the first proceeding included a dishonest or fraudulent act, which every policy excludes. The license defense benefit will normally pay counsel for a board proceeding, but many policies apply a single sublimit per policy period, so a licensee facing two boards over the same events can exhaust it on the first and pay for the second herself. Read the sublimit and the aggregation language before you need them.",
        "prevent": [
         ...
         "Assume the second board will learn of the first board&rsquo;s action; the failure to report is a separate charge that you control entirely, unlike the underlying discipline.",
         "When you settle with one board, negotiate knowing a second proceeding is coming, and ask whether the second board&rsquo;s conditions can be made to run concurrently with the first, as the supervision term was here."
        ],
    },
    {
        # source: BBS decision 036.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-a-mandated-report-never-filed",
        "group": "another",
        "t": "A year of abuse disclosures, no report filed",
        "dek": "The psychology board heard the evidence and imposed probation; the BBS case ended in surrender.",
        "role": "LMFT",
        "eff": "May 15, 2025",
        "case": "2002024002543",
        "hear": null,
        "facts": [
         ...
         "Across those months the client described her husband&rsquo;s violence toward the boys. In February 2019 the older boy said his father choked him while brushing his teeth on vacation; his voice was raspy and his face red. On April 25, 2019 both boys said their father slapped the older boy outside a restaurant. On May 27, 2019 the younger boy said their father had slammed the older boy&rsquo;s head into a car window and strangled him in the car; the mother photographed the injury. On August 30, 2019 the older boy said his father kicked him in the back and the younger boy said his father slapped him, leaving a red handprint the mother also photographed. The respondent&rsquo;s own clinical notes recorded the February, April, and August accounts in her own words.",
        ...
        "prevent": [
         ...
         "Write down the date and time you filed each report and keep the confirmation with the chart. This respondent&rsquo;s own progress notes became the strongest evidence against her, precisely because they recorded the disclosures and nothing about a report."
        ],
    },
    {
        # source: BBS decision 040.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-two-nursing-actions-before-registration",
        "group": "applying",
        "t": "Two nursing board actions, then an MFT application",
        "dek": "The Board denied the application, then agreed to issue the registration under two years&rsquo; probation and a recordkeeping course.",
        "role": "AMFT",
        "eff": "July 24, 2025",
        "case": "2002024001842",
        "hear": null,
        "facts": [
         "The respondent held a California registered nurse license. On or about April 5, 2022 the Board of Registered Nursing issued a disciplinary decision placing that license on <b>two years&rsquo; probation</b>, effective May 5, 2022. The nursing board had found that in a 2019 incident, while working as a registered nurse, she engaged in conduct demonstrating incompetence and made false or grossly incorrect entries in a hospital record.",
        ...
        "charges": [
         ...
         [
          "16 CCR &sect;1812",
          null,
          "Defines when a crime, act, or instance of professional misconduct is &ldquo;substantially related&rdquo; &mdash; whether to a substantial degree it evidences present or potential unfitness to perform the licensed functions consistent with public health, safety, or welfare."
         ],
         [
          "16 CCR &sect;1813",
          null,
          "Sets the rehabilitation criteria the Board applies to an applicant: the nature and gravity of the misconduct, anything committed since, the time elapsed, compliance with any probation or other sanctions, and the applicant&rsquo;s own evidence of rehabilitation."
         ]
        ],
        "outcome": "The Board ordered that the registration be issued once the respondent completes all registration requirements, then immediately revoked, with the revocation stayed and the respondent placed on two years&rsquo; probation. Conditions include at least one hour a week of individual face-to-face supervision by an independent Board-approved supervisor, two graduate semester units in medical recordkeeping and documentation within 18 months, notification of every employer, quarterly reports under penalty of perjury, and $1,200 a year in probation monitoring costs.",
        "cost": null,
        "rule": "Discipline on any other license follows you into a Board of Behavioral Sciences application. Business and Professions Code section 480(a)(2) lets the Board deny an application when the applicant has been formally disciplined by a licensing board in or outside California within the seven years before the application, for professional misconduct substantially related to the profession now being sought; the clock runs from the date of the other board&rsquo;s discipline to the date of your application, not from the underlying conduct. Section 4982.25(a) goes further and makes discipline by another state, territory, or governmental agency on any healing-arts license unprofessional conduct in its own right, with a certified copy of the other board&rsquo;s decision treated as conclusive evidence that it happened &mdash; so the facts behind it are not open to relitigation here. The duty to disclose binds applicants, not just licensees, and it does not stop when you hit send: an application stays open until the Board acts, and discipline that lands while it is pending becomes part of the case.",
        "ins": "Nothing about this case is insurable. A professional liability policy pays for negligent acts, errors, and omissions in providing professional services; it excludes intentional acts, criminal acts, and fraud, and falsifying a chart entry is intentional by definition. There was also no client claim here and no damages to indemnify. What a policy sold to a California therapist usually does include is a license-defense benefit &mdash; a capped reimbursement for the lawyer who answers a Board investigation letter, negotiates a stipulation, or appears at an administrative hearing. That benefit generally attaches to a licensee or registrant, so an applicant who has not yet been registered often has no coverage at all for exactly the proceeding described here, and pays out of pocket.",
        "prevent": [
         ...
         "When the other board&rsquo;s findings were about documentation, fix documentation before you apply. Take the recordkeeping coursework voluntarily and file the certificate with the application rather than waiting to be ordered into it."
        ],
    },
    {
        # source: BBS decision 044.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-felony-child-endangerment-never-reported",
        "group": "conviction",
        "t": "Felony child endangerment, and no answer to the Board",
        "dek": "She filed no notice of defense, so every allegation was taken as true and the registration was revoked by default.",
        "role": "ASW",
        ...
        "facts": [
         ...
         "On or about October 9, 2021, in violation of a temporary guardianship order that had awarded custody of her daughter to the child&rsquo;s grandmother, the respondent took the child from the grandmother&rsquo;s residence without the guardian&rsquo;s permission or knowledge and refused to return her to the guardian.",
         ...
         "On June 24, 2022 she was convicted in two Riverside County Superior Court cases. In the first, she was convicted of felony child endangerment under Penal Code section 273a(a) &mdash; a count set to be reduced to a misdemeanor after two years of successful probation &mdash; and was ordered to serve jail time, to complete <b>four years of formal probation</b> and a one-year child abuse treatment program, and to pay fines, fees, and restitution. In the second, she was convicted of felony assault with a deadly weapon other than a firearm under Penal Code section 245(a)(1) and misdemeanor resisting arrest under Penal Code section 148(a)(1), and was ordered to serve jail time, complete three years of probation, a 52-week domestic violence program, a counseling and rehabilitation program, and 20 hours of community service, and pay fines, fees, and restitution.",
        ...
        "charges": [
         ...
         [
          "B&amp;P &sect;4992.3(f)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4992.3&lawCode=BPC",
          "Violating, attempting to violate, or conspiring to violate the licensing chapter or any regulation the Board has adopted &mdash; the hook that turns a reporting regulation into a cause for discipline."
         ],
         [
         ...
         [
          "16 CCR &sect;1881(t)",
          null,
          "Requires the licensee or registrant to provide documentation about their arrest to the Board within 30 days of the Board&rsquo;s request."
         ],
         [
          "16 CCR &sect;1812",
          null,
          "Defines &ldquo;substantially related&rdquo; as conduct that to a substantial degree evidences present or potential unfitness to practice consistent with public health, safety, or welfare."
         ],
         [
          "16 CCR &sect;1814(a)",
          null,
          "Lists the rehabilitation criteria the Board weighs before revoking: severity, later conduct, time elapsed, compliance with probation, any Penal Code section 1203.4 expungement, and the licensee&rsquo;s own evidence."
         ],
         [
          "B&amp;P &sect;4990.33",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4990.33&lawCode=BPC",
          "The expiration, cancellation, forfeiture, suspension, or voluntary surrender of a license or registration does not deprive the Board of jurisdiction to investigate or to revoke."
         ],
         [
    ...
    {
        # source: BBS decision 045.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-signed-her-supervisors-name",
        "group": "applying",
        "t": "She wrote her supervisor&rsquo;s name on the hours forms",
        "dek": "The Board revoked her registration, granted her a new one on three years&rsquo; probation, and cut the cost award from $10,650 to $3,000.",
        "role": "APCC",
        "eff": "January 18, 2024",
        "case": "2002022001395",
        ...
        "charges": [
         ...
         [
          "B&amp;P &sect;4990.33",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4990.33&lawCode=BPC",
          "Expiration, cancellation, or surrender of a registration does not deprive the Board of jurisdiction to proceed &mdash; which is how a registration already cancelled at its six-year limit could still be revoked."
         ],
         [
          "B&amp;P &sect;4990.34",
        ...
        "outcome": "The Associate Professional Clinical Counselor registration was revoked. The application for a subsequent associate registration was granted: the registration issues on completion of all requirements, is then immediately revoked, that revocation is stayed, and the respondent is on three years&rsquo; probation with weekly psychotherapy, two graduate semester units in law and ethics, supervised practice once she is licensed, and $1,200 a year in monitoring costs.",
        "cost": "$3,000.00",
        "rule": "Every signature on a document you send the Board must be made by the person whose name it is. Business and Professions Code section 4999.90(b) reaches fraud, deceit, or misrepresentation on any application for licensure or registration or on the documents supporting it, and it binds two people at once &mdash; the applicant who submits the form and the licensee who signs in support of it. Subdivision (j) reaches any dishonest act substantially related to the license, whether or not it works. The supervisor&rsquo;s signature on an experience verification form is the only independent confirmation the Board has that the hours are real, so what is being certified is the signature and not the arithmetic; it was no defense here that the numbers were accurate and identical to what the supervisor had already reviewed. The parallel provisions for the other Board licenses are sections 4982(b) and (k) for marriage and family therapists and 4992.3(b) and (l) for clinical social workers, and section 4990.33 means a registration that has expired or hit its six-year cap is still within reach.",
        "ins": "A forged signature is an intentional act, and every professional liability policy excludes intentional acts, dishonesty, and fraud from indemnity. There is nothing here for a policy to pay on the merits. Where a policy would have helped is the part of the case that actually cost money: the license-defense benefit, which reimburses the fee of a lawyer to answer the accusation, prepare the mitigation record, and appear at hearing. This matter ran to a two-day administrative hearing followed by written argument to the Board, and the respondent was represented by counsel throughout. Read the sublimit on your own policy and note that it is usually a fixed dollar cap, not a percentage &mdash; a contested two-day hearing can exhaust a small one.",
        "prevent": [
         "Never sign, trace, type, or otherwise supply another person&rsquo;s name on a Board document, even when you hold their signed original for identical content and are certain of what they would sign.",
         ...
         "At the end of any supervision relationship, get complete signed verification forms and keep copies. Supervisors leave, move states, and lose access to the records that prove your hours &mdash; which is exactly what happened here."
        ],
    },
    {
        # source: BBS decision 048.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-probation-traded-for-surrender",
        "group": "conviction",
        "t": "A 0.15 breath test and two missed 30-day deadlines",
        "dek": "She won a probation lighter than the Board&rsquo;s own guideline minimum, then surrendered the registration less than two years into it.",
        "role": "AMFT",
        "eff": "December 14, 2023",
        "case": "2002024000775",
        ...
        "facts": [
         ...
         "When officers moved to handcuff her she pulled her arm away, kicked one officer&rsquo;s leg, and pinched his thumb. She stood on the running board of the patrol car and locked her legs to keep officers from putting her inside, then yelled and screamed once she was in. Two breath tests at the Highway Patrol office established a blood alcohol level of <b>0.15 percent</b>.",
         "The Board received notice of the arrest from the Department of Justice on September 15, 2019 &mdash; two days later. On January 8, 2020 the respondent pleaded no contest in Alameda County Superior Court to reckless driving with alcohol involvement, the disposition commonly called a wet reckless. She was sentenced to 30 days in jail or a work alternative program, three years of probation, a three-month DUI program, alcohol testing, and fines and fees. She completed every term and received a Penal Code section 1203.4 dismissal on March 3, 2021.",
         "On April 15, 2020 the Board wrote asking for documentation about the arrest and told her she had 30 days to respond. She did not respond in time. She testified that she notified the Board on August 24, 2020 &mdash; more than 30 days after the arrest, more than 30 days after the Board&rsquo;s letter, and more than 30 days after the conviction. She also had a 2005 conviction for driving with a blood alcohol level of 0.08 percent or higher, which she had disclosed when she registered and which had already produced a Board action.",
        ...
        "charges": [
         ...
         [
          ...
          null,
          "The wet reckless provision: when a drunk driving charge is reduced to reckless driving, the prosecutor states on the record that the offense involved alcohol, and that statement is recorded on the driver&rsquo;s history."
         ],
         [
          "B&amp;P &sect;125.3",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=125.3&lawCode=BPC",
        ...
        "outcome": "The registration was revoked, the revocation stayed, and the respondent placed on three years&rsquo; probation with a psychological or psychiatric evaluation, weekly psychotherapy, total abstinence from alcohol and controlled substances with random testing, an addictive behavior support group, and two graduate semester units in substance abuse; no actual suspension and no supervised practice were imposed. Less than two years in she invoked the order&rsquo;s license-surrender condition, and the Board accepted the surrender effective December 14, 2023, barring her from applying for any Board registration or license for three years and deeming every charge admitted against any future application.",
        "cost": null,
        "rule": "Two separate 30-day clocks run in a California criminal case, and they are independent of each other and of how the criminal case ends. Title 16, California Code of Regulations, section 1845(g)(1) requires a marriage and family therapist licensee or registrant to report any felony or misdemeanor conviction to the Board within 30 days, and the regulation counts a verdict of guilty or a plea of guilty or no contest as the conviction &mdash; so the clock starts at the plea, not at sentencing and not when criminal probation ends. Section 1845(h) gives you 30 days from the date the Board asks to produce documentation about your arrest. The parallel rules for clinical social workers are sections 1881(s)(1) and (t). Neither duty is excused because the Board already knows &mdash; here it had the arrest from the Department of Justice two days after it happened &mdash; and neither is erased by a later Penal Code section 1203.4 dismissal, which the respondent obtained and which sections 490 and 4982(a) expressly disregard.",
        "ins": "Drunk driving is a criminal act, and no professional liability policy indemnifies a criminal act, an intentional act, or the consequences of either. There was no client claim in this case and nothing for a policy to pay in damages. The coverage that mattered is the license-defense benefit: reimbursement for a lawyer to respond to the Board, negotiate, and appear at hearing. The respondent represented herself at a contested hearing and, on the strength of what she put in, avoided both an actual suspension and a supervised-practice requirement &mdash; but note that no policy covers the cost of probation itself. The evaluation, the weekly therapy, the random testing, the graduate coursework, and the annual monitoring fee were all hers to pay, and that recurring expense is a large part of why people surrender.",
        "prevent": [
    ...
    {
        # source: BBS decision 063.txt, redacted by _dev/../bbs pipeline
        ...
        "dek": "The Board denied the application, then settled by issuing the registration under five years&rsquo; probation and a psychological evaluation.",
        "role": "ASW",
        "eff": "March 6, 2025",
        "case": "2002024001328",
        "hear": null,
        "facts": [
         "The acts underlying the respondent&rsquo;s conviction occurred on or about January 25, 2002. On or about July 1, 2003, in Los Angeles County Superior Court, he was convicted of two felony counts of violating Penal Code section 245(d)(2), assault on a peace officer or firefighter with a semiautomatic firearm, and admitted a special allegation under Penal Code section 12022.53(c) that he personally and intentionally discharged a firearm in the commission of the crime.",
         "The court sentenced him to <b>34 years in prison</b>, with a recommendation that he receive schooling and job training. He was discharged from parole on or about July 26, 2021.",
        ...
        "charges": [
         ...
         [
          ...
          "Requires every board to publish criteria for whether a crime is substantially related &mdash; gravity, years elapsed, and the duties of the profession &mdash; and forbids denying a license in whole or in part on a conviction without considering the applicant&rsquo;s rehabilitation evidence."
         ],
         [
          "B&amp;P &sect;493",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=493&lawCode=BPC",
         ...
         [
          "16 CCR &sect;1812",
          null,
          "Defines &ldquo;substantially related&rdquo; as conduct that to a substantial degree evidences present or potential unfitness to perform the licensed functions consistent with public health, safety, or welfare."
         ],
         [
          "16 CCR &sect;1813",
          null,
          "Sets out how the Board evaluates rehabilitation on an application, including whether the criminal sentence was completed without a parole or probation violation, the length and terms of supervision, the time elapsed, and the applicant&rsquo;s own evidence."
         ],
         [
        ...
        "outcome": "The Board ordered that the registration be issued once the respondent completes all registration requirements, then immediately revoked, with the revocation stayed and the respondent placed on five years&rsquo; probation. Conditions include a psychological or psychiatric evaluation within 90 days and periodically after, compliance with the evaluator&rsquo;s recommendations, two graduate semester units in anger management within 18 months, supervised practice once he is licensed as a clinical social worker, reporting any violation of law within 72 hours, and $1,200 a year in monitoring costs.",
        "cost": null,
        "rule": "A conviction does not have to be recent to reach a license application. Business and Professions Code section 480(a)(1) lets the Board deny where the applicant was convicted of a substantially related crime within the seven years before the application &mdash; but the same subdivision also reaches an applicant who is presently incarcerated for such a crime, or who was released from incarceration for one within those seven years. The window therefore runs from release, not from conviction, which is why a 2003 conviction was still live against a 2023 application; serious felonies as defined in Penal Code section 1192.7 are drawn out for separate treatment. What the statute does not permit is an automatic no: sections 481(c) and 493(b)(2) both forbid the Board from denying on a conviction, or categorically barring an applicant by conviction type, without weighing the rehabilitation evidence the applicant files under the criteria in title 16 section 1813. That evidence has to come from the applicant, and the Board can only weigh what is in front of it.",
        "ins": "There is no insurance for this. A professional liability policy responds to negligent acts, errors, and omissions in providing professional services, and it excludes criminal acts and intentional acts entirely; a conviction and the licensing consequences of a conviction are outside every policy sold to a California therapist. The license-defense benefit that policies do carry is the one part of the market that touches Board proceedings, but it is written for licensees and registrants defending conduct during a policy period &mdash; an applicant contesting a denial over a pre-existing conviction has no policy yet and nothing to claim under. An applicant in this position pays for their own counsel, or, as here, represents themselves. Buy the policy when the registration issues, and read what its license-defense section actually covers before you need it.",
        "prevent": [
    ...
    },
    {
        ...
        "charges": [
         [
          "B&amp;P &sect;4990.33",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4990.33&lawCode=BPC",
          "The Board keeps jurisdiction to investigate and discipline even after a license or registration expires, is cancelled, or is voluntarily surrendered."
         ],
         [
         ...
         [
          "Probation Condition 18 &mdash; Reimbursement of Probation Program",
          null,
    ...
    {
        # source: BBS decision 076.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-road-rage-and-a-default-revocation",
        "group": "conviction",
        "t": "A drive-through altercation, then no answer to the Board",
        "dek": "He never reported the conviction, never answered two letters, and never filed a notice of defense; the registration was revoked without a hearing.",
        "role": "AMFT",
        "eff": "August 15, 2024",
        "case": "2002023001429",
        "hear": null,
        "facts": [
         "On or about December 16, 2022, officers were dispatched to a fast-food restaurant to investigate an altercation in the drive-through lane. Witness statements, security footage, and mobile-phone footage showed that the respondent pulled his car in front of another driver&rsquo;s car and that she yelled at him. He got out, walked to her window, reached into her car, and tried to take the phone out of her hand. He fell, got up, and tried to take the phone again. He then called her a racial slur and told her to go back where she came from, or words to that effect.",
         ...
         "The Board took the case by default, found the allegations true by clear and convincing evidence on the investigatory evidence packet alone, and found the actual costs of investigation and enforcement to be <b>$2,597.50</b> as of June 11, 2024."
        ],
        "charges": [
         [
          "B&amp;P &sect;490",
         ...
         [
          "16 CCR &sect;1845(h)",
          null,
          "Failure to give the Board documentation about the licensee&rsquo;s or registrant&rsquo;s arrest within 30 days of a request is unprofessional conduct."
         ],
         [
          "B&amp;P &sect;4990.33",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4990.33&lawCode=BPC",
          "Expiration, cancellation, or surrender of a registration does not deprive the Board of jurisdiction to start or finish a disciplinary case."
         ],
         [
          "B&amp;P &sect;125.3",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=125.3&lawCode=BPC",
        ...
        "outcome": "Registration revoked by default under Government Code section 11520. The decision records investigation and enforcement costs of $2,597.50; the order itself directed revocation and gave him seven days after service to move to vacate the decision for good cause.",
        "cost": "$2,597.50",
        "rule": "A conviction creates two separate duties, and the second one is the one people miss. The first is substantive: a conviction substantially related to the profession is a ground for discipline, weighed on the nature and gravity of the offense, the years since it happened, and the duties of the profession. The second is procedural and absolute: within 30 days of any felony or misdemeanor conviction &mdash; including one entered on a plea of guilty or no contest &mdash; you must report it to the Board in writing, and within 30 days of a Board request you must produce documentation about an arrest. Both duties run to the address of record you are required to keep current, and service there is effective whether or not you open the mail. Failing to file a notice of defense within 15 days of an accusation waives the hearing and lets the Board decide the case on its own evidence packet.",
        "ins": "A professional liability policy would not have touched the underlying conduct. Assault and battery are intentional and criminal acts, excluded from every professional liability policy, and the incident had nothing to do with professional services in any event. What a policy usually does provide is a separate license-defense limit covering the cost of an attorney when the Board opens an investigation or files an accusation &mdash; which is precisely the point in a case like this. That coverage is only useful if you notify the carrier when the Board&rsquo;s first letter arrives; it cannot help after a default has been entered.",
        "prevent": [
         "Report any conviction &mdash; misdemeanor, infraction-adjacent, or no-contest plea &mdash; to the Board in writing within 30 days, without waiting for sentencing, expungement, or your criminal lawyer to finish.",
    ...
    {
        # source: BBS decision 077.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-almost-forty-years-of-rehabilitation",
        "group": "applying",
        "t": "A 1985 murder conviction, and a 2024 registration on probation",
        "dek": "The judge found cause to deny and granted the application anyway: nearly 40 years, a clean parole, and a master&rsquo;s degree in counseling.",
        "role": "APCC",
        "eff": "August 15, 2024",
        "case": "2002023002544",
        ...
        "facts": [
         ...
         "On November 14, 1986, an Orange County jury convicted him of second degree murder under Penal Code section 187 and found that he had personally used a firearm in the commission of a felony under Penal Code section 12022.5. He was sentenced to <b>17 years to life</b> in state prison. He was released to parole on March 31, 2011 and was successfully discharged from parole on April 1, 2016, with no parole violations.",
        ...
        "charges": [
         ...
         [
          "16 CCR &sect;1813",
          null,
          "The rehabilitation criteria a board must apply to an applicant: nature and gravity of the crime, later acts, time elapsed, compliance with the terms of probation or parole, and the applicant&rsquo;s own evidence of rehabilitation."
         ],
         [
          "Pen. Code &sect;187",
    ...
    {
        # source: BBS decision 095.txt, redacted by _dev/../bbs pipeline
        "slug": "discipline-case-serious-felonies-ignore-the-seven-year-rule",
        "group": "applying",
        "t": "Nearly sixteen years on, a 2008 conviction still reached the application",
        "dek": "The seven-year lookback in section 480 does not apply to serious felonies; the registration issued on three years of probation.",
        "role": "ASW",
        "eff": "December 4, 2025",
        "case": "2002024002349",
        "hear": null,
        "facts": [
         ...
         "On May 22, 2008, in Orange County Superior Court, he was found guilty and convicted of attempted murder under Penal Code sections 664(a) and 187(a), and of two counts of assault with a deadly weapon other than a firearm, great bodily injury likely, under Penal Code section 245(a)(1). All three counts were felonies. At a sentencing hearing on December 12, 2008 he was sentenced to <b>7 years to life</b> in state prison with credit for 250 days served.",
         ...
         "The Board&rsquo;s cause for denial rested on the exception in the statute rather than the ordinary rule. Section 480(a)(1) normally lets a board deny an application only for a conviction within the preceding seven years, and nearly sixteen years had passed. But the seven-year limit does not apply where the applicant was convicted of a serious felony as defined in Penal Code section 1192.7, and the Board cited two of that section&rsquo;s definitions: subdivision (c)(9), attempted murder, and subdivision (c)(23), any felony in which the defendant personally used a dangerous or deadly weapon.",
         "He was represented by counsel and settled, admitting the truth of every charge and allegation and agreeing to be bound by the Board&rsquo;s probationary terms. The decision contains no factual findings about anything he did between 2008 and the application."
        ],
        "charges": [
         [
          "B&amp;P &sect;480(a)(1)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=480&lawCode=BPC",
          "A board may deny an application for a substantially related conviction within the preceding seven years &mdash; except that the seven-year limit falls away for a serious felony under Penal Code section 1192.7 or an offense requiring sex offender registration."
         ],
         [
          "B&amp;P &sect;4992.3(a)",
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4992.3&lawCode=BPC",
        ...
        "outcome": "The application was granted by stipulation. The registration issues on completion of all requirements, is immediately revoked, the revocation is stayed, and the respondent is on three years of probation, with $1,200 a year in probation monitoring costs.",
        "cost": null,
        "rule": "The seven-year lookback in section 480 is not a clean slate. For a serious felony as defined in Penal Code section 1192.7, and for offenses requiring sex offender registration, the time limit disappears and a conviction of any age remains a ground for denial. Subdivision (c)(23) of that definition sweeps in any felony in which the defendant personally used a dangerous or deadly weapon, so a weapon in the file is usually enough to remove the time bar entirely. Everything else still applies: the Board must still find the crime substantially related, must still work through the rehabilitation criteria, and cannot bar an applicant categorically by conviction type. The age of the conviction becomes an argument about rehabilitation rather than a limit on the Board&rsquo;s reach.",
        "ins": "There is nothing insurable in the criminal conduct; intentional acts, criminal acts, and fraud are excluded from every professional liability policy. The coverage that matters to a person in this position is license-defense expense, the separate limit inside most professional liability policies that pays an attorney to represent you in a Board matter. An applicant has no registration and usually no policy, so the legal fees in a Statement of Issues case come out of pocket &mdash; this respondent hired his own counsel. Once the registration issues, buy the policy immediately, and understand that the probation itself is a consequence, not a claim: no insurer reimburses the $1,200 annual monitoring fee, the psychological evaluation, or the weekly therapy the order requires.",
        "prevent": [
         "Do not assume an old conviction has aged out; check whether it is a serious felony under Penal Code section 1192.7 &mdash; which includes any felony involving personal use of a weapon &mdash; before you rely on the seven-year window.",
