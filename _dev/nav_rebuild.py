...
LEARN = [
    ...
    ("associate-therapist-pay-los-angeles-bay-area.html", "LA and Bay Area pay",
     "salary or per session, with the published scales",
     "therapist-cost-of-living-california.html"),
    ...
    ("questions.html", "Every question",
     "the complete index, phrased as people ask it",
     "resources.html"),
    ("changes.html", "What changed",
     "the numbers that moved, with sources",
