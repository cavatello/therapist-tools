...
function blank(){
  var s = {rate:"", sessions:"", weeksOff:2, billingPct:2.5,
    ...
    /* seasonality: a named shape, plus per-month overrides as PERCENTAGES of
       the annual average (blank = follow the shape). Percentages rather than
       multipliers because a reader typing "70" for July is unambiguous in a way
       that "0.7" is not. */
    shape:"typical", months:["","","","","","","","","","","",""]};
